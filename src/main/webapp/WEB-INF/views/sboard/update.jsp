...
<div class="whole">
<form action="/sboard/update" method="post" class="enrollform" name="studyinfo" enctype="multipart/form-data" onsubmit="return check()">  
	<div class="content">
<input type="hidden" name="studyNo" value="${param.studyNo }">
	
		<div class="con-detail">
			<div class="title">
				<img src="/resources/se2/img/cloud-solid.svg"  id="img-detail">
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyTitle" name="studyTitle" placeholder="스터디의 제목을 입력하세요." value="${updateDetail.STUDY_TITLE }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="title">
				...
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyContent" name="studyContent" placeholder="스터디의 내용을 입력하세요." value="${updateDetail.STUDY_CONTENT }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="title">
				...
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyTag" name="studyTag" placeholder="태그를 설정하세요" value="${updateDetail.STUDY_TAG }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="">
				...
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyPeople" name="studyPeople" placeholder="스터디에 참여할 인원을 입력하세요.(숫자로 입력해주세요.)" value="${updateDetail.STUDY_PEOPLE }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="title">
				...
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyAddress" name="studyAddress" placeholder="스터디 장소를 입력하세요." value="${updateDetail.STUDY_ADDRESS }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="title">
				...
				<div class="mb-3">
  					<input type="date" class="form-control" id="studyDate" name="studyDate" placeholder="스터디 날짜를 입력하세요." value="${updateDetail.STUDY_DATE }">
				</div>
			</div>
		</div>
		<div class="con-detail">
			<div class="title">
				...
				<div class="mb-3">
  					<input type="text" class="form-control" id="studyTime" name="studyTime" placeholder="스터디가 진행 될 시간를 입력하세요." value="${updateDetail.STUDY_TIME }">
				</div>
			</div>
		</div>
		<div class="con-detail">
...
<!-- 		 <button class="btn btn-primary" type="submit" data-bs-target="staticBackdrop" data-bs-toggle="modal" style="background-color: #6cc4dc; border: none;">신청하기</button> -->
		<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="background-color: #6cc4dc; border: none;">수정하기</button> 
		</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        스터디 수정이 성공적으로 완료되었습니다.<br>
<!--         최종 등록 여부는 마이페이지에서 확인하실 수 있습니다. -->
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btnUpdate" style="background-color:#6cc4dc; border: none;">확인</button>
      </div>
    </div>
  </div>
</div>
